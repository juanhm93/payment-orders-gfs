...
<template>
  <section class="flex w-full justify-center px-4 py-8">
    <div class="w-full max-w-7xl">
      <h1 class="text-2xl font-bold pb-6">Ordenes de pago</h1>
      ...
      <div v-if="orderStore.isLoading" id="loading-orders">
      ...
      <div
        v-show="showCardOrdersHaveData"
        id="table-orders__mobile"
        class="flex flex-col gap-4 md:hidden mt-4"
      >
